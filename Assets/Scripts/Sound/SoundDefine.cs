...
{
    // BGM
    public const string BGM_Main = "menu-bg";
    ...
    public const string SFX_Normal = "normal-value";
    public const string SFX_Low = "low-value";
    public const string SFX_Score1 = "score1";
    public const string SFX_Score2 = "score2";
}
